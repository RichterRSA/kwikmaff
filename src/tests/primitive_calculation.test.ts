...
describe("PrimitiveCalculation", () => {
  ...
  test("both sides are PrimitiveCalculations", () => {
    ...
    const addition = new PrimitiveCalculation(
      innerCalculation1,
      innerCalculation2,
      "+"
    );
    ...
    const subtraction = new PrimitiveCalculation(
      innerCalculation1,
      innerCalculation2,
      "-"
    );
    ...
    const multiplication = new PrimitiveCalculation(
      innerCalculation1,
      innerCalculation2,
      "*"
    );
    ...
    const division = new PrimitiveCalculation(
      innerCalculation1,
      innerCalculation2,
      "/"
    );
